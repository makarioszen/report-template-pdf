...
public class ToHtmlConverter extends AbstractSample {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * CSS reset, see
		 * http://itumbcom.blogspot.com.au/2013/06/css-reset-how-complex
		 * -it-should-be.html
		 * 
		 ...
		 * margin-top is set to 1em in html.css)
		 * 
		 * Setting margin: 0 on p is enough to fix it.
		 * 
		 * See further
		 * http://www.css-101.org/articles/base-styles-sheet-for-webkit
		 * -based-browsers/
		 */
	...
	//
	// @Override
	// public Element createStyleElement(OpcPackage opcPackage, Document
	// document,
